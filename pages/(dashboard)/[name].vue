...
useHead({
  title: `${fruitName.charAt(0).toUpperCase() + fruitName.slice(1)} - Detalhes`,
});
                  ...
                  <div class="w-full h-4 overflow-hidden rounded-full bg-muted">
                    <div
                      ...
                      :style="`width: ${Math.min(
                        fruit.nutritions.carbohydrates * 3,
                        100
                      )}%`"
                    ></div>
                  </div>
                ...
                <div class="flex items-center gap-4">
                  <div class="w-full h-4 overflow-hidden rounded-full bg-muted">
                    <div
                      ...
                      :style="`width: ${Math.min(
                        fruit.nutritions.sugar * 5,
                        100
                      )}%`"
                    ></div>
                  </div>
                  <span class="w-24 text-sm">
                    Açúcar: {{ fruit.nutritions.sugar }}g
                  </span>
                </div>
                ...
                <div class="flex items-center gap-4">
                  <div class="w-full h-4 overflow-hidden rounded-full bg-muted">
                    <div
                      ...
                      :style="`width: ${Math.min(
                        fruit.nutritions.protein * 12,
                        100
                      )}%`"
                    ></div>
                  </div>
                  <span class="w-24 text-sm">
                    Proteína: {{ fruit.nutritions.protein }}g
                  </span>
                </div>
                ...
                <div class="flex items-center gap-4">
                  <div class="w-full h-4 overflow-hidden rounded-full bg-muted">
                    <div
                      ...
                      :style="`width: ${Math.min(
                        fruit.nutritions.fat * 10,
                        100
                      )}%`"
                    ></div>
                  </div>
                  <span class="w-24 text-sm">
                    Gordura: {{ fruit.nutritions.fat }}g
                  </span>
                </div>
              </div>
            </div>
